...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Tournament.challonge_id'
        db.alter_column(u'compo_tournament', 'challonge_id', self.gf('django.db.models.fields.CharField')(max_length=10))

    def backwards(self, orm):

        # Changing field 'Tournament.challonge_id'
        db.alter_column(u'compo_tournament', 'challonge_id', self.gf('django.db.models.fields.IntegerField')())
    ...
    models = {
        ...
        u'compo.tournament': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'max_participants': ('django.db.models.fields.IntegerField', [], {'default': '0', 'blank': 'True'}),
