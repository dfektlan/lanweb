...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Tournament.challonge_type'
        db.add_column(u'compo_tournament', 'challonge_type',
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Tournament.challonge_type'
        db.delete_column(u'compo_tournament', 'challonge_type')
