...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Tournament.challonge_id'
        db.add_column(u'compo_tournament', 'challonge_id',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Tournament.challonge_id'
        db.delete_column(u'compo_tournament', 'challonge_id')
    ...
    models = {
        ...
        u'compo.tournament': {
            ...
            'challonge_id': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
