...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Application.crew'
        db.alter_column(u'crew_application', 'crew_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['crew.CrewTeam']))

    def backwards(self, orm):

        # Changing field 'Application.crew'
        db.alter_column(u'crew_application', 'crew_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['crew.Crew']))
    ...
    models = {
        ...
        u'crew.application': {
            ...
            'event': ('django.db.models.fields.related.ForeignKey', [], {'default': '[<LanEvent: dfekt LAN Vinter 2014>]', 'to': u"orm['event.LanEvent']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        u'crew.crewteam': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'members': ('django.db.models.fields.related.ManyToManyField', [], {'to': u"orm['userprofile.SiteUser']", 'symmetrical': 'False'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '30'})
        },
        u'event.lanevent': {
