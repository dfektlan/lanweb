...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'crew_application', (
            ...
            ('event', self.gf('django.db.models.fields.related.ForeignKey')(default=[], to=orm['event.LanEvent'])),
        ))
    ...
    models = {
        ...
        u'crew.application': {
            ...
            'event': ('django.db.models.fields.related.ForeignKey', [], {'default': '[]', 'to': u"orm['event.LanEvent']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
