...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'SessionProfile'
        db.create_table(u'sessionprofile_sessionprofile', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('session', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['sessions.Session'], unique=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['userprofile.SiteUser'], null=True)),
        ))
        db.send_create_signal(u'sessionprofile', ['SessionProfile'])


    def backwards(self, orm):
        # Deleting model 'SessionProfile'
        db.delete_table(u'sessionprofile_sessionprofile')
    ...
    models = {
        ...
        u'sessionprofile.sessionprofile': {
            'Meta': {'object_name': 'SessionProfile'},
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'session': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['sessions.Session']", 'unique': 'True'}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['userprofile.SiteUser']", 'null': 'True'})
        },
        u'sessions.session': {
