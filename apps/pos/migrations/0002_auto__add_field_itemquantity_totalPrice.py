...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ItemQuantity.totalPrice'
        db.add_column(u'pos_itemquantity', 'totalPrice',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ItemQuantity.totalPrice'
        db.delete_column(u'pos_itemquantity', 'totalPrice')
    ...
    models = {
        ...
        u'pos.itemquantity': {
            ...
            'totalPrice': ('django.db.models.fields.IntegerField', [], {})
        },
        u'pos.order': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'items': ('django.db.models.fields.related.ManyToManyField', [], {'to': u"orm['pos.Item']", 'null': 'True', 'through': u"orm['pos.ItemQuantity']", 'symmetrical': 'False'}),
