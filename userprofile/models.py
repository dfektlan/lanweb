...
class SiteUser(AbstractUser):
    ...
    date_of_birth = models.DateField(_(u'Fødselsdag'), null=True)
    phone = models.CharField(_(u'Telefonnummer'), max_length=16)
    skype = models.CharField(_(u'Skype'), max_length = 200)
    steam = models.CharField(_(u'Steam'), max_length=200)
    ...
    position = models.CharField(_(u'Posisjon'), max_length=200)
    objects = UserManager()
